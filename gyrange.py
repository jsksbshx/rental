...
 Usage: /remove <userid>'''
        ...
        response = "Purchase karle bsdk:- @saiyam_96."
...
def welcome_start(message):
    ...
    response = f'''🔥saiyam ke LODE pe aapka swagat hai, {user_name}! Sabse acche se bgmi ki maa behen yahi hack karta hai. Kharidne ke liye Kira se sampark karein.
